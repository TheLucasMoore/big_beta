...
class GradesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create grade" do
    assert_difference('Grade.count') do
      post grades_url, params: { grade: { rating: @grade.rating, system: @grade.system } }, as: :json
    end
  ...
  test "should update grade" do
    patch grade_url(@grade), params: { grade: { rating: @grade.rating, system: @grade.system } }, as: :json
    assert_response 200
  end
